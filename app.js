...
/* تحويل بعض الكلمات الفرنسية للعربية */
...
function openOpportunityById(id) {
  ...
  openOpportunity(
    translateText(opportunity.title),
    translateText(opportunity.category),
    opportunity.location,
    translateText(opportunity.description),
    "مفتوحة"
  );
